...
exports.defineManualTests = function(contentEl, createActionButton) {
    ...
    createActionButton('MAS.getFromPath()', function() {
        ...
        mas.getFromPath(startSuccessHandler, errorHandler, '/protected/resource/products', parameters, headers, 0, 0);
    ...
    createActionButton('MAS.getFromPath() OTP', function() {
        ...
        var headers = { "headerName": "headerValue" };
        mas.getFromPath(startSuccessHandler, errorHandler, '/otpProtected', parameters, headers, 0, 0);
