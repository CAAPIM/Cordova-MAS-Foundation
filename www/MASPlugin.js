...
var MASPlugin = {
    ...
    */
    MASUser: function(){
        ...
        */
        ...
        this.isAuthenticated=function(successHandler, errorHandler){
            return Cordova.exec(successHandler,errorHandler,"com.ca.apim.MASPlugin","isUserAuthenticated",[]);
        };
    },
    ...
    MASApplication: function() {
        ...
        this.isAuthenticated=function(successHandler, errorHandler){
            return Cordova.exec(successHandler,errorHandler,"com.ca.apim.MASPlugin","isApplicationAuthenticated",[]);
        };
    },
